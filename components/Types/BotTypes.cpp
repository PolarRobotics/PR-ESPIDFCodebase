...
constexpr Pair<BotType, const char*> botTypeStrings[NUM_POSITIONS] = {
    {lineman, "lineman"},
    {receiver, "receiver"},
...
/**
 * @brief getBotName uses the index of the bot, to index the bot configuration
 * array, defined in BotTypes.h if the bot index is out of range of the number
 * of possible bots, returns "Robot"
 *
