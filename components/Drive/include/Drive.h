...
#define STRENGTH_LINEMAN_ACCELERATION_RATE 0.002f  // slower acceleration for strength linemen
#define STRENGTH_LINEMAN_DECELERATION_RATE 0.0005f // slower deceleration for strength linemen
